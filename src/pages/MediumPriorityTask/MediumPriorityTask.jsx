...
const MediumPriorityTask=()=>{
    ...
    const assignedToMeTasks = tasks?.filter(task=> task.assignTo === currentUser.displayName && task.priority === "medium");
    ...
    if(mediumPriorityTasks.length === 0){
        return(
            <div className="flex justify-center flex-col items-center h-screen -mt-20">
                <h2 className="text-4xl font-semibold">No Medium Priority Task Found!</h2>
    ...
    return(
        <div className="ps-10 pt-5">
            <div>
                <h2 className="text-3xl font-bold">Medium Priority Tasks</h2>
                <div className="pt-5 overflow-x-auto">
                    <table className="table">
                        <tbody className="flex flex-col">
                            {
                                mediumPriorityTasks?.map(task=> <Link
                                    key={task._id}
...
export default MediumPriorityTask;